...
def print_menu():
    ...
    print("\t0. Exit\n"
          ...
          "\t16. Get the lowest cost walk between two given vertices\n")
...
def start():
    ...
    while True:
        ...
        if not menu_option.isnumeric():
            ...
            # Minimum cost walk between 2 vertices
            elif menu_option == 16:
                print(Graph.shortest_path(graph, 1, 0))
                # vertex1 = input("\t-first vertex: ")
                # vertex2 = input("\t-second vertex: ")
                # if not vertex1.isnumeric() or not vertex2.isnumeric():
                #     print("The vertices must be numbers!")
                # print("The minimum cost walk is:")
                # except Exception as e:
                #     print(str(e))
