    ...
    def delete_assignment_of_student(self, assignment_id, student_id):
        for grade in self._list_of_grades:
            if grade.assignment_id == assignment_id and grade.student_id == student_id:
                deleted_grade = grade
                self._list_of_grades.remove(grade)
...
class GradeTextFileRepository(GradeRepository):
    def __init__(self):
        super().__init__()
        self._file_name = r"C:\Users\Irina\Desktop\PycharmProjects\a9-ScortarIrina\src\Files\TextFiles\grades.txt"
        self._clear_file()
...
class GradeBinaryFileRepository(GradeRepository):
    def __init__(self):
        super().__init__()
        self._file_name = r"C:\Users\Irina\Desktop\PycharmProjects\a9-ScortarIrina\src\Files\BinaryFiles\grades.bin"
        self._clear_file()
