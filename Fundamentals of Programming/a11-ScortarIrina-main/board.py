    ...
    def is_won(self):
        ...
        for row in range(6):
            for column in range(3):
                if (self.__board[row][column] == '   %   ' or self.__board[row][column] == '   #   ') and (self.__board[row][column] == self.__board[row][column + 1] == self.__board[row][column + 2] == self.__board[row][column + 3]):
                    return True

        # Check columns for winner
        for column in range(6):
            for row in range(3):
                if (self.__board[row][column] == '   %   ' or self.__board[row][column] == '   #   ') and (self.__board[row][column] == self.__board[row + 1][column] == self.__board[row + 2][column] == self.__board[row + 3][column]):
                    return True

        # Check diagonal (top-left to bottom-right) for winner
        for row in range(3):
            for column in range(4):
                if (self.__board[row][column] == '   %   ' or self.__board[row][column] == '   #   ') and (self.__board[row][column] == self.__board[row + 1][column + 1] == self.__board[row + 2][column + 2] == self.__board[row + 3][column + 3]):
                    return True
