...
class Ui:
    ...
    def display_list_of_students(self):
        ...
        for student in students_service.get_list_of_students():
            print(str(student))

    def display_list_of_assignments(self):
        try:
            assignments_service = self._assignments_service
            for assignment in assignments_service.get_list_of_assignments():
    ...
    def display_list_of_grades(self):
        try:
            ...
            for grade in grades_service.get_list_of_grades():
                print(str(grade))
        except ValueError as ve:
            print(str(ve))
    ...
    def make_statistics(self):
        ...
        if not user_option.isnumeric():
            ...
            try:
                list_for_statistics = self._grades_service.get_students_with_pass_deadline_assignments()
